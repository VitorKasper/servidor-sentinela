...
// Leitor e visualizador de READMEs (Admin e Operador)
router.get('/:id/readme', isAuthenticated, requireOperatorOrAdmin, readmeController.showReadmeView);
router.get('/:id/readme/content', isAuthenticated, requireOperatorOrAdmin, readmeController.getReadmeContentApi);
